...
export default function RecentCharacters({
  ...
  return (
    <section className="rounded-3xl border border-slate-800 bg-slate-900/70 p-8">
      ...
      {characters.length === 0 ? (
        <div className="mt-8 rounded-2xl border border-dashed border-slate-700 bg-slate-950/40 p-8 text-center">
        ...
        <div className="mt-8 divide-y divide-slate-800/70">
          {characters.map((character) => (
            ...
            >
              {character.avatar ? (
                ...
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full border border-slate-700 bg-slate-800 text-xl">
                  👤
                </div>
              )}
      ...
      <Link
        href="/characters"
        className="mt-6 flex items-center justify-center gap-2 border-t border-slate-800/70 pt-5 text-sm font-semibold text-violet-400 transition hover:text-violet-300 sm:hidden"
      >
