...
export default function RecentProjects({
  ...
  return (
    <section className="rounded-3xl border border-slate-800 bg-slate-900/70 p-8">
      ...
      <Link
        href="/projects"
        className="mt-6 flex items-center justify-center gap-2 border-t border-slate-800/70 pt-5 text-sm font-semibold text-fuchsia-400 transition hover:text-fuchsia-300 sm:hidden"
      >
